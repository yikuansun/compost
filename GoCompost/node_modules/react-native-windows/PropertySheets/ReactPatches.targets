...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <Target Name="EvaluateReactPatchInputs" BeforeTargets="CopyReactPatches">
    ...
    <ItemGroup>
      <DeforkingPatchCommonFiles Include="$(DeforkingPatchCommonPath)\**" />
      <ReactCommonSrcFiles Include="$(ReactCommonSrcPath)\**\*.cpp;$(ReactCommonSrcPath)\**\*.h" />
      <UnpatchedReactCommonSrcFiles Include="@(ReactCommonSrcFiles)" Condition="!Exists('$(DeforkingPatchCommonPath)\%(RecursiveDir)%(Filename)%(Extension)')" />
