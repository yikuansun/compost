...
class TabBarBottom extends React.Component {
  ...
  render() {
    ...
    const tabBarStyle = [styles.tabBar, isDark ? styles.tabBarDark : styles.tabBarLight, // @ts-ignore
    this._shouldUseHorizontalLabels() && !_reactNative.Platform.isPad ? styles.tabBarCompact : styles.tabBarRegular, innerStyle];
