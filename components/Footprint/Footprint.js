...
/*
      ...
      <View>
        ...
        <Text style={{fontSize: 20, fontWeight: "bold", marginBottom:5}}>{parseFloat(this.state.totalWeight.toFixed(1))} lbs</Text>
                      </View>
                     ...
                     (<DateTimePickerModal
                      ...
                      <View style={{flex: 1, flexDirection: 'row'}}>
                          <View style={{flex: 1, flexDirection: 'column', borderRadius: 10, backgroundColor: "#FEFED4", margin: 9}}>
                              ...
                              <Text style={{textAlign: 'center', fontSize: 20, fontWeight:"bold"}}>{parseFloat(this.state.totalWeightToday.toFixed(1))} lbs</Text>
                          </View>
                          <View style={{flex: 1, flexDirection: 'column', borderRadius: 10, backgroundColor: "#cfcfcf", margin: 9}}>
                              ...
                              <Text style={{textAlign: 'center', fontSize: 20, fontWeight:"bold"}}>{parseFloat(this.state.totalWeightLastWeek.toFixed(1))} lbs</Text>
                          </View>
                          <View style={{flex: 1, flexDirection: 'column', borderRadius: 10, backgroundColor: "#C1C19C", margin: 9}}>
                              ...
                              <Text style={{textAlign: 'center', fontSize: 20, fontWeight:"bold"}}>{parseFloat(this.state.totalWeightLastMonth.toFixed(1))} lbs</Text>
                          </View>
                      </View>
